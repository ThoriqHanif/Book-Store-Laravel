          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ '/buku/'.$data->id }}" method="post" style="margin-top: -80px">
                    @method('PUT')
                    @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label>ID Buku</label>
                      <input type="number" class="form-control" name="id" value="{{ $data->id }}" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="tanggal_terbit" value="{{ $data->tanggal_terbit }}">
                    </div>
                    <div class="form-group">
